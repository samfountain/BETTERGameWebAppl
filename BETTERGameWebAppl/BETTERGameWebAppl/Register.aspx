...
<body>
    ...
    <section class="registerform">
            ...
            <br />
            <asp:Label ID="lblcountry" Text="Country" runat="server"></asp:Label><br />
...
<asp:ListItem Value="ZW">Zimbabwe</asp:ListItem>
            ...
            <asp:Label ID="duplicateUsername" runat="server" Visible="false" ForeColor="Red" Text="Label">Username is already in use!</asp:Label>
                <br />
                <br />
                <br />
            ...
            <asp:LinkButton CssClass="HomeButtons" ID="btnRegister" OnClick="btnRegister_Click" runat="server" ValidationGroup="1">Register</asp:LinkButton>
